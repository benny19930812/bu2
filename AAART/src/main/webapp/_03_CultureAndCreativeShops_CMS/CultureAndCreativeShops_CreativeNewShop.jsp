...
<meta charset="UTF-8">
<title>文創商店 後台管理系統 新增商家資料</title>
</head>
<body>
	<h2>文創商店 後台管理系統</h2>
	<h3>新增商家資料</h3>
	<form method="post" action="<c:url value = "CultureAndCreativeShops_CreativeNewShop"/>">
		<table>
	...
	<!-- ====================================================== -->
			...
			<label>點擊次數:</label>
			<input type="text" placeholder="請輸入" name="Clicks">
			<span id=idsp class="colorGray"></span>
			<br />
			<p class="colorGray">不可空白</p>
