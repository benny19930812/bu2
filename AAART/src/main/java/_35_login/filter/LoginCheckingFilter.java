...
@WebFilter(
		urlPatterns = { "/*" }, 
		initParams = { 
				@WebInitParam(name = "mustLogin1", value = "/_35_csrService/*"), 			
				@WebInitParam(name = "mustLogin2", value = "/_03_CultureAndCreativeShops_CMS/*"),				
				@WebInitParam(name = "mustLogin3", value = "/_14_shopAP/*"),				
				@WebInitParam(name = "mustLogin4", value = "/_04_Orderlist/*"),				
				@WebInitParam(name = "mustLogin5", value = "/_04_ShopCart/*")				
		})
