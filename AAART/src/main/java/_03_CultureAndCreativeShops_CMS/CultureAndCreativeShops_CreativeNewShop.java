 ...
 */
@WebServlet("/_03_CultureAndCreativeShops_CMS/CultureAndCreativeShops_CreativeNewShop")
public class CultureAndCreativeShops_CreativeNewShop extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (shops_DAO.creatNewShop(shop) == true) {
			request.setAttribute("shopCreateMsg", "商家新增成功");
		} else {
			request.setAttribute("shopCreateMsg", "商家新增失敗");
		}
